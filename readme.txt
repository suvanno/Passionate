...
Passionate WordPress Theme, Copyright 2015 Daisy Themes
Passionate is distributed under the terms of the GNU GPL v3
...
3. Font-Awesome.css - http://fontawesome.io/
   Licensed under the MIT license - http://opensource.org/licenses/MIT
...
4. Swiper.css - http://idangero.us/swiper/
   Licensed under the MIT license - http://opensource.org/licenses/MIT
...
1. http://startupstockphotos.com/
   https://s3.amazonaws.com/StartupStockPhotos/uploads/37.jpg
...
Version 1.2.1
* Fixed escapes and text-domain issues

Version 1.2
* Fixed php error for Image Slider

Version 1.1.2
* Fixed tag and function prefix

Version 1.1.1
* Fixed licencing, js errors and maintain some WordPress Coding Standard 
